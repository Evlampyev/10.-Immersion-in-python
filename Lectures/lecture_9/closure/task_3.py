# Но функцию из task_3.py можно переписать иначе. Вспомним, что в Python все функции
# высшего порядка. А это значит, что их можно передавать как объекты в другие функции:
