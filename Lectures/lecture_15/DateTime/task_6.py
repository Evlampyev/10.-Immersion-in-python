...
date_text = ('Дата 15 June 2007. День недели Friday. '
             'Время 02:14:00. Это 24 неделя и 166 день года.')
...
text_date = datetime.strptime(date_text, 'Дата %d %B %Y. День недели %A. '
                                         'Время %H:%M:%S. Это %W неделя и %j день года.')
print(original_date)
