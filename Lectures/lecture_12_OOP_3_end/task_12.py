...
class Triangle:
    ...
    __slots__ = ('_a', '_b', '_c')  # заменяет __dict__, и делает класс не расширяемым,
    # с невозможностью вводить новые свойства
...
if __name__ == '__main__':
    ...
    print(triangle)
    print(triangle.__dict__) # AttributeError: 'Triangle' object has no attribute
    # '__dict__'. Did you mean: '__dir__'? Если есть __slots__
