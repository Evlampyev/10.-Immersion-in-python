...
# Создаём генератор на основе двух списков x и y. 7 элементов в первом списке
# и 6 во втором. Всего 13. Генератор считает сумму пар элементов.
...
# подумать, что на выходе получим 10 элементов - 5 из x и 5 из y.
# Но циклы вложены друг в друга, следовательно, количество элементов
